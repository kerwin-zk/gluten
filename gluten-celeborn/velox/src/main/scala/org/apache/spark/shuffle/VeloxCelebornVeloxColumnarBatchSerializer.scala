...
class CelebornVeloxColumnarBatchSerializer(
    schema: StructType,
  ...
  override def newInstance(): SerializerInstance = {
    new CelebornVeloxColumnarBatchSerializerInstance(schema, readBatchNumRows, numOutputRows)
  }
}

private class CelebornVeloxColumnarBatchSerializerInstance(
    schema: StructType,
    readBatchNumRows: SQLMetric,
    numOutputRows: SQLMetric)
    ...
    new DeserializationStream {
      ...
      private lazy val wrappedOut: GeneralOutIterator = new ColumnarBatchOutIterator(
        ...
        ShuffleReaderJniWrapper
          .create()
          .readVeloxStream(shuffleReaderHandle, byteIn),
        nmm)
